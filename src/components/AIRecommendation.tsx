      ...
      <div className="bg-white rounded-3xl max-w-lg w-full max-h-[90vh] overflow-y-auto shadow-2xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-6 rounded-t-3xl relative">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h2 className="text-2xl font-bold">AI 마라톤 추천</h2>
              <p className="text-white/90 text-sm">당신에게 딱 맞는 대회를 찾아드려요!</p>
            </div>
          </div>
          ...
          {step < questions.length ? (
            ...
            <div className="space-y-4 animate-slideIn">
              <div className="text-center mb-6">
                <p className="text-2xl mb-2">{questions[step].options[0].emoji}</p>
                <h3 className="text-xl font-bold text-gray-800">{questions[step].question}</h3>
              </div>
            ...
            <div className="space-y-4 animate-slideIn">
              <div className="text-center mb-4">
                <div className="inline-block bg-gradient-to-r from-yellow-400 to-orange-400 p-3 rounded-2xl mb-3">
                  <Sparkles className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-bold text-gray-800 mb-2">당신을 위한 추천 대회</h3>
                <p className="text-muted-foreground text-sm">총 {recommendations.length}개의 대회를 찾았어요!</p>
              </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-bold text-gray-800 mb-1 group-hover:text-primary transition-colors">{marathon.name}</h4>
                        <p className="text-sm text-muted-foreground mb-2">{marathon.scenery}</p>
            ...
            <div className="text-center py-8 animate-slideIn">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">조건에 맞는 대회가 없어요</h3>
              <p className="text-muted-foreground mb-6">다른 조건으로 다시 시도해보세요!</p>
              <button
                onClick={resetQuiz}
